...
<template>
  <div class="sidebar-env">
    ...
    <section class="section">
      <h3 class="section__title">Protected Area Designations</h3>
      <div v-if="data.designations?.length">
        ...
        >
          ...
          <span class="designation-row__pct">{{ d.pct_overlap.toFixed(0) }}%</span>
        </div>
      </div>
    ...
    <!-- Flood risk -->
    <section class="section">
      <h3 class="section__title">Flood Risk</h3>
      <div class="kv-row">
    ...
    <!-- Landslide -->
    <section class="section">
      <h3 class="section__title">Landslide Susceptibility</h3>
      <div class="kv-row">
